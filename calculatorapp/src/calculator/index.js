...
// import eight from "../musicreact/8.mp3";
// import nine from "../musicreact/9.mp3";
...
//   };
//   const playSound8 = () => {
//     const audio = new Audio(eight);
//     audio.play();
//   };
//   const playSound9 = () => {
//     const audio = new Audio(nine);
//     audio.play();
//   };
...
//             Result
//           </button>
//           <button className="result" onClick={handleBackspace}>
//             Back
//           </button>
//         </div>
...
//                   <li key={index}>
//                     Input: {entry.input}, Output: {entry.result}, Time:{" "}
//                     {entry.time}
//                   </li>
//                 ))}
//               </ul>
...
function Calcu() {
  ...
  const handleNumberClick = (num, sound) => {
  ...
  return (
    <div className="div1">
      <h1>Calculator using React Application</h1>
      <div className="calculator">
        <input
          className="input"
          type="text"
